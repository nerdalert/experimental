...
UI_USER="${UI_USER:-praxis}"
UI_PASSWORD="${UI_PASSWORD:-redhat123}"
...
CONSUMER_A="${CONSUMER_A_DEPLOY:-consumer-east}"
CONSUMER_B="${CONSUMER_B_DEPLOY:-consumer-west}"
...
sample_state() {
  local label="$1" now overlay_json candidates grid_json
